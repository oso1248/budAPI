...
def upgrade():
    ...
    op.create_table('brand_brewing',
                    ...
                    sa.Column('methods_acx', sa.JSON(), nullable=True),
                    sa.Column('methods_csx', sa.JSON(), nullable=True),
    ...
    op.create_table('brand_finishing',
                    ...
                    sa.Column('is_organic', sa.Boolean(), nullable=False),
                    sa.Column('note', sa.String(), nullable=True),
                    sa.Column('methods_filters', sa.JSON(), nullable=True),
                    sa.Column('methods_releasing', sa.JSON(), nullable=True),
                    sa.Column('is_active', sa.Boolean(), nullable=False),
